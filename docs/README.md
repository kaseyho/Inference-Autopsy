...
| `workflow/phase-3-testing-guide.md` | Step-by-step Phase 3 testing guide | Verifying `bench`, built-in profiles, closed-loop concurrency, and JSONL output | Prove the workload runner produces trace evidence |
